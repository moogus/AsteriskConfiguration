...
{
  class AutoAttendantRules : IAutoAttendantRules
  {
    private readonly IRepository _repository;
    private readonly ISessionWrapper _session;
    private readonly FuAutoAttendantRules _under;

    public AutoAttendantRules(FuAutoAttendantRules under, ISessionWrapper session, IRepository repository)
    {
      _under = under;
      _session = session;
    ...
    public AutoAttendantRules(ISessionWrapper session, IRepository repository)
    {
      _session = session;
      _repository = repository;
