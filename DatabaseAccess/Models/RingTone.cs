...
{
    internal class RingTone : IRingTone, IModel
    {
       private readonly ISessionWrapper _session;
        private readonly FuRingtone _under;

        internal RingTone(FuRingtone under, ISessionWrapper session, IRepository repository)
        {
            _under = under;
            _session = session;
        }

        internal RingTone(ISessionWrapper session, IRepository repository)
        {
            _session = session;
