...
{
    internal class Default : IDefault, IModel
    {
        private readonly FuDefaults _under;
        private readonly ISessionWrapper _session;

        internal Default(FuDefaults under, ISessionWrapper session, IRepository repository)
        {
            _under = under;
            _session = session;
        }

        internal Default(ISessionWrapper session, IRepository repository)
        {
            _session = session;
