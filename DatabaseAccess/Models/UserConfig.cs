...
namespace DatabaseAccess.Models
{
    ...
    internal class UserConfig : IUserConfig, IModel
    {
        private readonly FuUserConfig _under;
        private readonly ISessionWrapper _session;
        private readonly IRepository _repository;

        internal UserConfig(FuUserConfig under, ISessionWrapper session, IRepository repository)
        {
            _under = under;
            _session = session;
        ...
        internal UserConfig(ISessionWrapper session, IRepository repository)
        {
            _session = session;
            _repository = repository;
