...
{
    internal class AutoAttendant : IAutoAttendant, IModel
  {
    ...
    internal AutoAttendant(FuAutoAttendant under, ISessionWrapper session, IRepository repository)
    {
      _under = under;
      _session = session;
    ...
    internal AutoAttendant(ISessionWrapper session, IRepository repository)
    {
      _session = session;
      _repository = repository;
