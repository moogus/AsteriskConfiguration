var queueMember = function (config) {
  ...
  $("#showPenalty").click(function (e) { $("#penaltyInfo").show('fast'); e.preventDefault(); });
  $(".modalClose").click(function (e) { $("#penaltyInfo").hide('fast'); e.preventDefault(); });
  $("#showPaused").click(function (e) { $("#pausedInfo").show('fast'); e.preventDefault(); });
  $(".modalClose").click(function (e) {$("#pausedInfo").hide('fast');e.preventDefault();});
