	...
	// (both of which we optimize for)
        ...
        jQuery.fn = jQuery.prototype = {
            ...
            pushStack: function(elems, name, selector) {
                ///	<summary>
                ///     &#10;Context the jQuery object to an array of elements, while maintaining
                ///     &#10;the stack.
                ///     &#10;Part of Core
                ///	</summary>
                ///	<returns type="jQuery" />
...
// Give the init function the jQuery prototype for later instantiation
        ...
        jQuery.extend({
            ...
            // Is the DOM ready to be used? Context to true once it occurs.
            isReady: false,
            ...
            proxy: function(fn, proxy, thisObject) {
                ...
                // Context the guid of unique handler to the same of original handler, so it can be removed
                if (fn) {
...
// [vsdoc] Stubbing support properties to "false" for IntelliSense compat.
    ...
    jQuery.fn.extend({
        ...
        delay: function(time, type) {
            ///	<summary>
            ///     &#10;Context a timer to delay execution of subsequent items in the queue.
            ///	</summary>
    ...
    jQuery.fn.extend({
        attr: function(name, value) {
            ///	<summary>
            ///     &#10;Context a single property to a computed value, on all matched elements.
        ...
        val: function(value) {
            ///	<summary>
            ///     &#10;Context the value of every matched element.
            ///     &#10;Part of DOM/Attributes
            ///	</summary>
            ///	<returns type="jQuery" />
            ///	<param name="value" type="String">
...
// IE can't serialize <link> and <script> tags normally
    ...
    jQuery.fn.extend({
        text: function(text) {
            ///	<summary>
            ///     &#10;Context the text contents of all matched elements.
        ...
        clone: function(events) {
            ...
            ///     &#10;(Optional) Context to false if you don't want to clone all descendant nodes, in addition to the element itself.
            ///	</param>
        ...
        html: function(value) {
            ///	<summary>
            ///     &#10;Context the html contents of every matched element.
...
//	});
    ...
    jQuery.fn.css = function(name, value) {
        ///	<summary>
        ///     &#10;Context a single style property to a value, on all matched elements.
        ...
        // Contextting 'undefined' is a no-op
    ...
    if (!jQuery.support.opacity) {
        jQuery.cssHooks.opacity = {
            ...
            set: function(elem, value) {
                ...
                // Context the alpha filter to set the opacity
...
//	});
    ...
    jQuery.extend({
        ...
        ajaxSetup: function(settings) {
            ///	<summary>
            ///     &#10;Contexts up global settings for AJAX requests.
            ///	</summary>
		...
		traditional: false,
		*/
            // This function can be overriden by calling jQuery.ajaxContextup
            xhr: function() {
        ...
        // and if it's a DOM node or a jQuery collection
            ...
            function done(status, statusText, responses, headers) {
                ...
                if (status >= 200 && status < 300 || status === 304) {
                    ...
                    // Context the If-Modified-Since and/or If-None-Match header, if in ifModified mode.
                    if (s.ifModified) {
                ...
                // Context data for the fake xhr object
                jqXHR.status = status;
            ...
            // Context the correct header, if data is being sent
            ...
            // Context the Accepts header for the server, depending on the dataType
        ...
        param: function(a, traditional) {
            ...
            // Context traditional to true for jQuery <= 1.3.2 behavior.
    ...
    jQuery.fn.extend({
        show: function(speed, easing, callback) {
            ...
            if (speed || speed === 0) {
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    ...
                    // Context elements which have been overridden with display: none
                ...
                // Context the display of most of the elements in a second loop
        ...
        hide: function(speed, callback) {
            ...
            if (speed || speed === 0) {
                ...
                // Context the display of the elements in a second loop
                // to avoid the constant reflow
                for (i = 0; i < j; i++) {
            ...
            return this[optall.queue === false ? "each" : "queue"](function() {
                ...
                for (p in prop) {
                    ...
                    if (isElement && (p === "height" || p === "width")) {
                        ...
                        // Context display property to inline-block for height/width
...
//	});
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        jQuery.fn.offset = function(options) {
            ///	<summary>
            ///     &#10;Context the current coordinates of every element in the set of matched elements,
...
// Create innerHeight, innerWidth, outerHeight and outerWidth methods
    jQuery.each(["Height"], function(i, name) {
        ...
        jQuery.fn[type] = function(size) {
            ///	<summary>
            ///     &#10;Context the CSS height of every matched element. If no explicit unit
            ...
            ///     &#10;Context the CSS property to the specified value. Omit to get the value of the first matched element.
            ///	</param>
            ...
            if (jQuery.isWindow(elem)) {
                ...
                // Context the width or height on the element (default to pixels if value is unitless)
            } else {
...
// Create innerHeight, innerWidth, outerHeight and outerWidth methods
    jQuery.each(["Width"], function(i, name) {
        ...
        jQuery.fn[type] = function(size) {
            ///	<summary>
            ///     &#10;Context the CSS width of every matched element. If no explicit unit
            ///     &#10;was specified (like 'em' or '%') then &quot;px&quot; is added to the width.  If no parameter is specified, it gets
