var dynamicTable = function(config) {
    ...
    var publicMembers = {
        ...
        sort: function(sortCols) {
            datatable.fnSort(sortCols);
        }
    };
    ...
    var privateMembers = {
        ...
        initialise: function() {
            ...
            window.onbeforeunload = function() {
                if (privateMembers.alertTableInEdit === true) {
                    return "Please note that all unsaved changes will be lost.";
                }
            };
        },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            ...
                            privateMembers.alertTableInEdit = false;
                            // refresh table data
                            datatable.fnReloadAjax();
                        } else {
        ...
        editRow: function(row) {
            ...
            privateMembers.alertTableInEdit = true;
        },
