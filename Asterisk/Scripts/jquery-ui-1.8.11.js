...
//Where the click happened, relative to the element
            ...
            //Context a containment if given in the options
            if (o.containment)
...
/* Date picker manager.
   ...
   Contexttings for (groups of) date pickers are maintained in an instance object,
...
// Global defaults for all the date picker instances
    ...
    $.extend(Datepicker.prototype, {
	   ...
	   @param  target  element - the target input field or division or span */
        ...
        /* Context the dates for a jQuery selection.
	   @param  target   element - the target input field or division or span
...
// +1 week on ctrl or command +down
	   ...
	   @param  input  element - the input field attached to the date picker */
        ...
        /* Context as beforeShowDay function to prevent selection of weekends.
	   ...
	   @return [boolean, string] - is this date selectable?, what is its CSS class? */
        ...
        /* Context as calculateWeek to determine the week of the year based on the ISO 8601 definition.
...
/******************************************************************************/
    ...
    $.extend($.effects, {
        ...
        setMode: function(el, mode) {
            if (mode == 'toggle') mode = el.is(':hidden') ? 'show' : 'hide'; // Context for toggle
            return mode;
        },
...
(function($, undefined) {
    ...
    $.effects.blind = function(o) {
        ...
        return this.queue(function() {
            ...
            // Context options
            var mode = $.effects.setMode(el, o.options.mode || 'hide'); // Context Mode
...
(function($, undefined) {
    ...
    $.effects.bounce = function(o) {
        ...
        return this.queue(function() {
            ...
            // Context options
            var mode = $.effects.setMode(el, o.options.mode || 'effect'); // Context Mode
...
(function($, undefined) {
    ...
    $.effects.explode = function(o) {
        ...
        return this.queue(function() {
            ...
            // Context a timeout, to call the callback approx. when the other animations have finished
            setTimeout(function() {
...
(function($, undefined) {
    ...
    $.effects.scale = function(o) {
        ...
        return this.queue(function() {
            ...
            var mode = $.effects.setMode(el, o.options.mode || 'effect'); // Context Mode
            var percent = parseInt(o.options.percent, 10) || (parseInt(o.options.percent, 10) == 0 ? 0 : (mode == 'hide' ? 0 : 100)); // Context default scaling percent
            var direction = o.options.direction || 'both'; // Context default axis
            var origin = o.options.origin; // The origin of the scaling
            if (mode != 'effect') { // Context default origin and restore for show/hide
...
// Context scaling factor
            ...
            el.to = { height: original.height * factor.y, width: original.width * factor.x }; // Context to state
...
(function($, undefined) {
    ...
    $.effects.slide = function(o) {
        ...
        return this.queue(function() {
            ...
            // Context options
            var mode = $.effects.setMode(el, o.options.mode || 'show'); // Context Mode
            var direction = o.options.direction || 'left'; // Default Direction
